...
public class TestSubnet {
    public static void main(String[] args) {
        ...
        System.out.println("String Subnet: " + stringSubnet
        ...
        System.out.println("Address and Suffix Subnet: " + addressAndSuffixSubnet
        ...
        System.out.println("Address Subnet: " + addressSubnet
        ...
        System.out.println("Strings Subnet: " + stringsSubnet
        ...
        System.out.println("Get 1. Ip from Strings Subnet Array: " + stringsSubnet.getAllIpsInNetwork()[0]);
        System.out.println("Get 10. Ip from Strings Subnet Array: " + stringsSubnet.getAllIpsInNetwork()[10]);
        System.out.println("Get Last Ip from Strings Subnet Array: " + stringsSubnet.getAllIpsInNetwork()[stringsSubnet.getAllIpsInNetwork().length-1] + "\n");

        System.out.println("Get next Subnet of Strings Subnet Array: " + stringsSubnet.getNextSubnet() + "\n");
